...
namespace FileStorageLab
{
    public class HttpFilesHandler
    {
        ...
        {
            string part = ExtractUrlLastPart(context.Request.Url.LocalPath);
            ...
            try
            {
                ...
                {
                    path = path.Remove(path.Length - 1 - part.Length) + '/';
        ...
        private string ExtractUrlLastPart(string url)
        {
            int b = url.Length - 1;
            int a = b;
            ...
            return url.Substring(a, b - a + 1).Trim(' ');
        }
